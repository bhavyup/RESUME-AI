...
export function AppHeader({
  ...
  return (
    <header className="h-14 border-b backdrop-blur-xl fixed top-0 left-0 right-0 z-40 shadow-2xl border-slate-800/50 bg-slate-950/80">
      {/* Content Container */}
            ...
            <>
              ...
              <nav className="hidden md:flex items-center gap-1 lg:gap-2">
                {showUpgradeButton && (
                  <>
                    <ProUpgradeButton />
                    <div className="h-4 w-px bg-slate-700 ml-2 lg:ml-3" />
                  </>
                )}
                ...
                <div className="flex items-center px-2 lg:px-3 py-1">
                  ...
                  <div className="mx-1 lg:mx-2 h-4 w-px bg-slate-700" />
                  <SettingsButton />
                  <div className="mx-1 lg:mx-2 h-4 w-px bg-slate-700" />
                  <LogoutButton />
                </div>
              ...
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                <SheetTrigger asChild className="md:hidden">
                  <Button
                    variant="ghost"
                    size="icon"
                    className="h-9 w-9 text-slate-400 hover:text-amber-400"
                  >
                ...
                <SheetContent
                  side="right"
                  className="w-[280px] sm:w-[320px] bg-slate-900 border-slate-800"
                >
                  <SheetHeader>
                  ...
                  <div className="flex flex-col gap-4 pt-6">
                    ...
                    <Link
                      ...
                      className="flex items-center gap-2 px-4 py-2 rounded-md text-sm font-medium text-slate-400 hover:text-amber-400 hover:bg-slate-800 transition-colors duration-200"
                    >
                      <User className="h-4 w-4" />
                      Profile
                    </Link>
