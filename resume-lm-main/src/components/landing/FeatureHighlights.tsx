  ...
  return (
    <section className="py-24 md:py-32 px-4 sm:px-6 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto">
        ...
        <div className="absolute -top-28 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-br from-[#ddd6fe03] via-violet-500/10 to-indigo-200/5 blur-3xl -z-10"></div>
        <div className="absolute -top-10 -right-20 w-80 h-80 rounded-full bg-gradient-to-br from-cyan-200/5 to-teal-200/20 blur-3xl -z-10"></div>
        <div className="absolute -bottom-10 -left-20 w-72 h-72 rounded-full bg-gradient-to-tr from-rose-200/5 to-pink-200/20 blur-3xl -z-10"></div>
        ...
        >
          ...
          <span className="px-3 py-1 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-sm text-emerald-400">
            ATS-Optimized
          </span>
          <span className="px-3 py-1 rounded-full bg-slate-500/10 border border-slate-500/20 text-sm text-slate-400">
            100% Free
          </span>
        </motion.div>
        ...
        >
          <h2 className="text-4xl md:text-6xl font-bold leading-tight tracking-tight">
            ...
            <motion.span
              ...
              className="inline-block mt-1 bg-gradient-to-r from-emerald-400 to-teal-400 bg-clip-text text-transparent"
            >
              Get You Noticed
            </motion.span>
          </h2>
          ...
          >
            ...
            <span className="font-semibold text-emerald-400">3x</span>
          </motion.p>
        </motion.div>
        ...
        <div className="flex justify-center my-12">
          <div className="w-16 h-[3px] bg-gradient-to-r from-amber-500 to-yellow-500 rounded-full mx-1"></div>
          <div className="w-16 h-[3px] bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full mx-1"></div>
          <div className="w-16 h-[3px] bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mx-1"></div>
        </div>
      </div>
      ...
      >
        <div className="max-w-3xl mx-auto px-6 py-12 rounded-2xl bg-slate-900/50 backdrop-blur-lg border border-slate-800/50 shadow-2xl shadow-black/20">
          ...
          <p className="text-lg text-slate-400 mb-8">
            Join 500+ professionals who are getting more interviews with
            ResumeLM
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <AuthDialog>
              <button className="px-8 py-4 rounded-lg bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-900 text-lg font-semibold shadow-lg shadow-amber-500/30 transition-all duration-300 hover:-translate-y-1 hover:shadow-amber-500/50">
            ...
            <Link
              ...
              className="px-8 py-4 rounded-lg bg-slate-800 border border-slate-700 text-slate-200 text-lg font-medium transition-all duration-300 hover:-translate-y-1 hover:bg-slate-700"
            >
              <span className="bg-gradient-to-r from-amber-400 to-emerald-400 bg-clip-text text-transparent">
                View on Github
              </span>
      ...
      <div className="md:hidden fixed bottom-4 left-0 right-0 z-50 px-4">
        <AuthDialog>
          <button className="flex items-center justify-center w-full py-3.5 rounded-lg bg-gradient-to-r from-amber-500 to-yellow-500 text-slate-900 font-semibold shadow-lg shadow-amber-500/30">
            Get Started Now
          </button>
        </AuthDialog>
      </div>
