  ...
  return (
    <div
      className={cn(
        ...
        "before:absolute before:inset-0 before:bg-gradient-to-br before:from-slate-900/90 before:via-slate-800/90 before:to-slate-900/90 before:opacity-95",
        "after:absolute after:inset-0 after:bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] after:bg-[size:24px_24px] after:opacity-30",
        className
      )}
    >
        ...
        >
          ...
          {imageOverflowRight && (
            ...
            >
              ...
              {badgeText && (
                <div
                  className={`inline-block self-end px-4 py-1 rounded-full bg-gradient-to-r ${badgeGradient} border-amber-400/30 text-amber-300 text-sm font-medium mb-1 backdrop-blur-sm`}
                >
              ...
              <div className="space-y-2 inline-flex flex-col items-end w-full">
                <h2 className="text-4xl sm:text-5xl font-bold tracking-tight">
                  <span className="inline-block bg-gradient-to-r from-amber-400 via-yellow-400 to-amber-400 bg-clip-text text-transparent animate-gradient-x pb-2">
                    {heading}
                  </span>
                </h2>
                <div className="h-1 w-24 bg-gradient-to-r from-amber-500/80 to-emerald-500/80 rounded-full" />
              </div>
          ...
          >
            ...
            <div className="relative h-full w-full overflow-hidden rounded-2xl shadow-2xl shadow-black/40 border border-slate-800/50">
              <div className="relative h-full w-full p-2 bg-slate-900/30 backdrop-blur-sm">
                <Image
                  src={imageSrc}
                  alt={heading}
                  fill
          ...
          {!imageOverflowRight && (
            ...
            >
              ...
              {badgeText && (
                <div
                  className={`inline-block px-4 py-1 rounded-full bg-gradient-to-r ${badgeGradient} border-amber-400/30 text-amber-300 text-sm font-medium mb-1 backdrop-blur-sm`}
                >
                  <div className="flex items-center">
                    <span className="mr-2">{badgeText}</span>
                    <Star className="w-3.5 h-3.5 fill-current" />
