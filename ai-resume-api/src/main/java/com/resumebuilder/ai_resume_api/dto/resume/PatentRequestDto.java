...
@Schema(description = "Request DTO for creating or updating a patent", example = """
        {
            "title": "Patent Title",
            ...
            "officialUrl": "https://patents.example.com/1234567",
            "links": [
                {
                    "type": "OFFICIAL",
                ...
                """)
public record PatentRequestDto(
        ...
        @Pattern(regexp = "^[A-Z]{2,3}$", message = "jurisdictionCountry must be ISO alpha-2 or alpha-3 (e.g., US or USA)") String jurisdictionCountry,
        ...
        @NotEmpty List<@Size(max = 128) String> inventors,
