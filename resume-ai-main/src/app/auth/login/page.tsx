...
export const metadata: Metadata = {
  title: "Login | ResumeAI - AI-Powered Resume Builder",
  description: "Create tailored, ATS-optimized resumes powered by AI. ResumeAI helps you land your dream tech job with personalized resume optimization.",
...
export default async function LoginPage({
  ...
  return (
    <>
      <main className="relative overflow-x-hidden selection:bg-emerald-500/20 bg-slate-950">
        {/* Error Dialog */}
        ...
        <nav className="border-b border-slate-700/50 backdrop-blur-xl shadow-md fixed top-0 w-full bg-slate-950/80 z-[1000] transition-all duration-500">
                ...
                <div className="space-y-8">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full 
                      ...
                      hover:from-emerald-500/20 hover:via-teal-500/20 hover:to-cyan-500/20
                  ...
                  >
                    <svg
                      className="w-5 h-5 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-500"
                      fill="currentColor"
                      viewBox="0 0 24 24"
                      aria-hidden="true"
                    >
                    ...
                    <span className="text-sm font-semibold bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent">
                      Open Source on GitHub
                    </span>
                    <svg
                      className="w-4 h-4 text-emerald-400 transition-all duration-300 transform group-hover:translate-x-1 group-hover:text-emerald-300"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                  ...
                  <div className="space-y-5">
                    <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-tight">
                      <span className="inline-block bg-gradient-to-r from-emerald-400 via-teal-400 to-cyan-400 bg-clip-text text-transparent animate-gradient-x pb-2">
                        Free AI Resume Builder
                      </span>
                      <br />
                      <span className="relative inline-block">
                        <span className="inline-block bg-gradient-to-r from-emerald-300/90 via-teal-300/90 to-cyan-300/90 bg-clip-text text-transparent animate-gradient-x">
                          that lands you tech jobs
                        </span>
                        <div className="absolute -bottom-2 left-0 w-24 sm:w-32 h-1.5 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full" />
                      </span>
                    </h1>
                    
                    <p className="text-xl sm:text-2xl text-slate-400 leading-relaxed max-w-2xl font-medium">
              ...
              <div className="relative mt-8 lg:mt-0">
                ...
                <div className="block lg:hidden">
                  <div className="relative w-full max-w-[min(85vw,_6in)] mx-auto transform hover:scale-[1.02] transition-transform duration-700">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 rounded-sm transform rotate-3 scale-[1.03] shadow-xl" />
                    <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 to-teal-500/5 rounded-sm transform -rotate-3 scale-[1.03] shadow-xl" />
                ...
                <div className="relative hidden lg:block transform hover:scale-[1.02] transition-transform duration-700">
                  {/* Decorative Elements */}
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/8 to-teal-500/8 rounded-3xl transform rotate-6 scale-110 shadow-xl" />
                  <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/8 to-teal-500/8 rounded-3xl transform -rotate-6 scale-110 shadow-xl" />
                  
                  {/* Enhanced glow effect */}
                  <div className="absolute -inset-0.5 bg-gradient-to-r from-emerald-500/20 via-teal-500/20 to-cyan-500/20 rounded-3xl blur-xl opacity-70 group-hover:opacity-100 transition duration-1000"></div>
