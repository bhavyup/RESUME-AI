...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  const url = `https://ResumeAI.com/blog/${slug}`;
          ...
          <script
            ...
            dangerouslySetInnerHTML={{
              __html: JSON.stringify({
                ...
                description: post.frontMatter.description,
                image: 'https://ResumeAI.com/og.webp',
                ...
                publisher: {
                  ...
                  logo: {
                    '@type': 'ImageObject',
                    url: 'https://ResumeAI.com/og.webp',
                  },
                  url: 'https://ResumeAI.com',
                },
                mainEntityOfPage: {
                  '@type': 'WebPage',
                  '@id': `https://ResumeAI.com/blog/${slug}`,
                },
