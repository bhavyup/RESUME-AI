...
export function ResumeContextMenu({ children, resume, fontCapabilities }: ResumeContextMenuProps) {
  const handleDownloadPDF = async () => {
    try {
      const blob = await pdf(<ResumePDFDocument resume={resume} fontCapabilities={fontCapabilities ?? null} />).toBlob();
