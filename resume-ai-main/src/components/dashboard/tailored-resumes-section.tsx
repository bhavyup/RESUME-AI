...
interface TailoredResumesSectionProps {
  resumes: Resume[];
  baseResumes: Resume[];
  profile: Profile;
...
export function TailoredResumesSection({ 
  resumes,
  baseResumes,
  profile, 
  canCreateMore 
}: TailoredResumesSectionProps) {
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 blur-lg opacity-50" />
            <div className="relative h-10 w-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center shadow-lg shadow-teal-500/25">
          ...
          <div>
            <h2 className="text-xl font-semibold text-white flex items-center gap-2">
              Tailored Resumes
              <span className="px-2 py-0.5 text-xs font-medium bg-teal-500/20 text-teal-400 rounded-full border border-teal-500/30">
                {optimisticResumes.length}
              </span>
            </h2>
            <p className="text-sm text-slate-400">Customized for specific job applications</p>
          </div>
        </div>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button 
              variant="outline" 
              size="sm"
              className="gap-2 border-slate-700 bg-slate-800/50 text-slate-300 hover:bg-slate-700 hover:text-white focus-visible:ring-0 focus-visible:outline-none"
            >
            ...
            <CreateResumeDialog type="tailored" profile={profile} baseResumes={baseResumes}>
              <motion.button
                ...
                className={cn(
                  ...
                  "border-2 border-dashed border-teal-500/30 hover:border-teal-400/60",
              ...
              >
                ...
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                  ...
                  <div className="absolute top-0 left-0 w-full h-full bg-[radial-gradient(circle_at_30%_20%,rgba(20,184,166,0.15),transparent_50%)]" />
                  <div className="absolute bottom-0 right-0 w-full h-full bg-[radial-gradient(circle_at_70%_80%,rgba(6,182,212,0.15),transparent_50%)]" />
                </div>
                ...
                <div className="absolute inset-0 overflow-hidden">
                  {[...Array(8)].map((_, i) => (
                    ...
                    >
                      <Sparkles className="h-3 w-3 text-teal-400/50" />
                    </motion.div>
                  ))}
                </div>
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 blur-xl opacity-50 group-hover:opacity-75 transition-opacity" />
                  <div className={cn(
                ...
                <div className="relative z-10 text-center">
                  <p className="text-base font-semibold text-teal-400 group-hover:text-teal-300 transition-colors">
                ...
                {/* Bottom Glow Line */}
                <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-teal-500/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.button>
            </CreateResumeDialog>
          ) : (
            <Link href="#base-resumes">
              <motion.div
                ...
                className={cn(
                  ...
                  "border-2 border-dashed border-slate-600/50 hover:border-emerald-500/40",
                  "bg-gradient-to-br from-slate-900/80 via-slate-800/50 to-slate-900/80",
                  "flex flex-col items-center justify-center gap-4",
              ...
              >
                ...
                <div className="text-center relative z-10 px-4">
                  <p className="text-base font-semibold text-slate-400">Create Base First</p>
                  <p className="text-xs text-slate-500 mt-1">You need a base resume to create tailored versions</p>
                </div>

                <div className="flex items-center gap-1 text-xs text-emerald-400/70 group-hover:text-emerald-400 transition-colors">
                  <span>Create Base Resume</span>
            ...
            return (
              <motion.div
                ...
                className={cn(
                  ...
                  "shadow-xl shadow-black/20 hover:shadow-2xl hover:shadow-teal-500/10",
                  "transition-all duration-500",
              ...
              >
                ...
                {resume.isOptimistic && (
                  <div className="absolute inset-0 z-20 bg-slate-900/80 backdrop-blur-sm flex items-center justify-center">
                    <div className="flex flex-col items-center gap-2">
                      ...
                      <span className="text-xs text-teal-400">Creating...</span>
                    </div>
                  </div>
                )}
                ...
                <div className="absolute top-3 left-3 right-3 flex items-start justify-between z-10">
                  <motion.div
                    ...
                    className="flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-teal-500/20 border border-teal-500/30 backdrop-blur-sm"
                  >
                    <Sparkles className="h-3 w-3 text-teal-400" />
                    <span className="text-[10px] font-medium text-teal-400 uppercase tracking-wider">Tailored</span>
                  </motion.div>
                ...
                <Link href={`/resumes/${resume.id}`} className="block h-full">
                  <div className="relative h-full p-4 pt-14 flex flex-col">
                    ...
                    <div className="flex-1 relative">
                      <div className={cn(
                        ...
                        <div className="space-y-3">
                          <div className="space-y-1">
                            <div className="h-1.5 w-12 rounded-full bg-teal-500/30" />
                            <div className="space-y-1">
                          ...
                          <div className="space-y-1">
                            <div className="h-1.5 w-14 rounded-full bg-teal-500/30" />
                          ...
                          <div className="space-y-1">
                            <div className="h-1.5 w-10 rounded-full bg-teal-500/30" />
                      ...
                      >
                        <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-teal-500/20 border border-teal-500/30 backdrop-blur-sm">
                          ...
                          <span className="text-sm font-medium text-teal-400">View Resume</span>
                        </div>
                      </motion.div>
                    </div>
                    ...
                    <div className="mt-3 pt-3 border-t border-slate-700/50">
                      <h3 className="font-semibold text-white truncate text-sm group-hover:text-teal-400 transition-colors">
                        {resume.name}
                      </h3>
                ...
                {/* Bottom Glow */}
                <div className="absolute bottom-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-teal-500/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
              </motion.div>
            );
          })}
        </AnimatePresence>
      ...
      {optimisticResumes.length === 0 && (
        ...
        >
          <div className="relative inline-flex">
            ...
            <div className="relative h-20 w-20 rounded-2xl bg-gradient-to-br from-teal-500/20 to-cyan-500/20 border border-teal-500/30 flex items-center justify-center mx-auto">
              <Target className="h-10 w-10 text-teal-400" />
            </div>
          </div>
          <h3 className="mt-6 text-xl font-semibold text-white">No tailored resumes yet</h3>
          <p className="mt-2 text-slate-400 max-w-md mx-auto">
            {baseResumes.length > 0 
              ? "Create tailored versions of your base resumes for specific job applications."
              : "First create a base resume, then tailor it for specific job applications."
            }
          </p>
          {canCreateMore && baseResumes.length > 0 && (
            <CreateResumeDialog type="tailored" profile={profile} baseResumes={baseResumes}>
              <Button className="mt-6 bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-400 hover:to-cyan-400 text-white shadow-lg shadow-teal-500/25">
